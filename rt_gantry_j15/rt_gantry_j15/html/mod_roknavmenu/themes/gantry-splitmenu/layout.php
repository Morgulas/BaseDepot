...
if (!defined('SPLITMENU_TEMPLATE')) define('SPLITMENU_TEMPLATE','rt_gantry_j15');
...
?>
<?php
if ( ! defined('modRokNavMenuShowItemsSplitmenu') )
{
function showItemSplitmenu(&$item, &$menu) {
...
define('modRokNavMenuShowItemsSplitmenu', true);
}
?>
...
<ul class="menu<?php echo $class_sfx; ?> level1" <?php if($menu->getParameter('tag_id') != null):?>id="<?php echo $menu->getParameter('tag_id');?>"<?php endif;?>>
	<?php foreach ($menu->getChildren() as $item) :  ?>
		<?php showItemSplitmenu($item, $menu); ?>
	<?php endforeach; ?>
</ul>
<?php endif; ?>